...
// SQL作成&実行
$sql = 'INSERT INTO contact_table (id, contact_day, contact_person, company, customer_person,contact,created_at) VALUES (NULL, :contact_day, :contact_person, :company, :customer_person, :contact, now())';
